...
levels(as.factor(daily_sc$standardized_bs)) 
...
nb = 15000  # number of iterations at the beginning of the chain to discard (i.e., the burn-in)
nt = 1  # thinning rate
...
save(poisson_basic_cv, file = "2_pipeline/store/poisson_basic_cv.Rdata")