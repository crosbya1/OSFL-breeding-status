...
nb = 30000  # number of iterations at the beginning of the chain to discard (i.e., the burn-in)
nt = 5 # thinning rate
ni = 50000 # number of iterations per chain (including burn-in)
...
#Full convergence in ~1 hour, 15 minutes with 50k iterations
...
save(negbinom_basic_cv, file = "2_pipeline/store/negbinom_basic_cv.Rdata")
